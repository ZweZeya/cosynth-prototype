...
concur::queue<int> g_queue;

// Anchor: makes concur::spsc_queue<int,8388608>'s real implementation
...
template class concur::spsc_queue<int, 1 << 23>;
...
int main() {
    ...
    auto producer_thread = concur::spawn(producer);
    auto consumer_thread = concur::spawn(consumer);
